...
public class PlayerCollisionsTest {
    ...
    private PlayerCollisions pc_object;
    ...
    private void setup(){
        ...
        pc_object = new PlayerCollisions(point_object.load());
    }
    ...
    void player_ghost_COL() {
        pc_object.collide(player_object, ghost_object);
    ...
    void ghost_player_COL() {
        pc_object.collide(ghost_object, player_object);
        verify(player_object).setAlive(false);
        verify(player_object).setKiller(ghost_object);
        verify(player_object, never()).addPoints(anyInt());
    }
    ...
    void ghost_ghost_COL(){
        ...
        pc_object.collide(ghost_object, ghost_object2);
    ...
    void ghost_pellet_COL(){
        ...
        pc_object.collide(ghost_object, pellet_object);
    ...
    void pellet_ghost_COL(){
        ...
        pc_object.collide(pellet_object, ghost_object);
    ...
    void player_pellet_COL(){
        ...
        pc_object.collide(player_object, pellet_object);
    ...
    void pellet_player_COL(){
        ...
        // in a normal case 10 points are increased but here we are returning 557
        when(pellet_object.getValue()).thenReturn(577);
        pc_object.collide(pellet_object, player_object);
